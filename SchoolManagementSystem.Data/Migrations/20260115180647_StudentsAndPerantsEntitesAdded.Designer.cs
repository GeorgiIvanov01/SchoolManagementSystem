...
namespace SchoolManagementSystem.Data.Migrations
{
    ...
    [Migration("20260115180647_StudentsAndPerantsEntitesAdded")]
    partial class StudentsAndPerantsEntitesAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolManagementSystem.Data.Models.ApplicationUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolManagementSystem.Data.Models.GradeBook", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolManagementSystem.Data.Models.Parent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("SchoolManagementSystem.Data.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ParentStudent", b =>
                {
                    b.HasOne("SchoolManagementSystem.Data.Models.Parent", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolManagementSystem.Data.Data.Common.Emails", b =>
                {
                    b.HasOne("SchoolManagementSystem.Data.Models.Parent", "Parent")
                        .WithMany("Emails")
            ...
            modelBuilder.Entity("SchoolManagementSystem.Data.Models.GradeBook", b =>
                {
                    b.HasOne("SchoolManagementSystem.Data.Models.Student", "Student")
                        .WithOne("GradeBooks")
                        .HasForeignKey("SchoolManagementSystem.Data.Models.GradeBook", "StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
